...
class WasteData {
  static const Map<String, WasteCategory> categories = {
    'kain_besar': WasteCategory(
      id: 'kain_besar',
      namaId: 'Limbah Kain (Perca Besar)',
      namaEn: 'Fabric Scraps (Large Cut)',
      ukuranId: 'Kain',
      ukuranEn: 'Fabric',
      isB3: false,
    ...
    'kain_sedang': WasteCategory(
      id: 'kain_sedang',
      namaId: 'Limbah Kain (Perca Sedang)',
      namaEn: 'Fabric Scraps (Medium Cut)',
      ukuranId: 'Kain',
      ukuranEn: 'Fabric',
      isB3: false,
      deskripsiId: 'Potongan kain sisa konveksi yang cocok untuk aksesoris dan produk kerajinan.',
      deskripsiEn: 'Garment fabric offcuts suitable for lifestyle accessories.',
      rekomendasiId: [
    ...
    'kain_kecil': WasteCategory(
      id: 'kain_kecil',
      namaId: 'Limbah Kain (Serpihan Perca)',
      namaEn: 'Fabric Scraps (Trimmings)',
      ukuranId: 'Kain',
      ukuranEn: 'Fabric',
      isB3: false,
      deskripsiId: 'Sisa potongan kain perca dan serpihan hasil trimming potongan pola konveksi.',
      deskripsiEn: 'Fine textile trimming scraps and fabric remnants from garment finishing.',
      rekomendasiId: [
